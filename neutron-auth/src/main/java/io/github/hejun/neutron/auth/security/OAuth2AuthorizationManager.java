...
import io.github.hejun.neutron.auth.security.redisdto.OAuth2AuthorizationCodeGrantAuthorization;
import io.github.hejun.neutron.auth.security.redisdto.OAuth2AuthorizationGrantAuthorization;
import io.github.hejun.neutron.auth.security.redisdto.OAuth2DeviceCodeGrantAuthorization;
import io.github.hejun.neutron.auth.security.redisdto.OidcAuthorizationCodeGrantAuthorization;
import io.github.hejun.neutron.auth.security.util.OAuth2ModelMapper;
...
public class OAuth2AuthorizationManager implements OAuth2AuthorizationService {
    ...
    public void save(OAuth2Authorization authorization) {
        ...
        if (redisAuthorization == null) {
            throw new AuthenticationServiceException("Authentication convert failed");
        }
